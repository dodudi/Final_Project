...
INSERT INTO TABLE_MEMBER_COUPON(COUPON_NUMBER, COUPON_TYPE_NUMBER, MEM_ID) VALUES(TABLE_MEMBER_COUPON_NUMBER.NEXTVAL, 1, 'user02');
INSERT INTO TABLE_MEMBER_COUPON(COUPON_NUMBER, COUPON_TYPE_NUMBER, MEM_ID) VALUES(TABLE_MEMBER_COUPON_NUMBER.NEXTVAL, 2, 'user02');
...
WHERE TABLE_MEMBER_COUPON.COUPON_END_DATE <= SYSDATE+7;
commit;
--쿠폰 옵션 -----------------------------------------
