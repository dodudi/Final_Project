										...
										<table class="table table-bordered text-center">
											...
											<tbody>
												<c:forEach var="coupons" items="${memberCoupons}" varStatus="status">
													...
													<fmt:parseDate value="${coupons.COUPON_GET_DATE}" var="dateValue1"
														pattern="yyyy-MM-dd HH:mm:ss" />
													<fmt:formatDate value="${dateValue1}" var="dateGet"
														pattern="yyyy-MM-dd" />
													<fmt:parseDate value="${coupons.COUPON_END_DATE}" var="dateValue2"
														pattern="yyyy-MM-dd HH:mm:ss" />
													<fmt:formatDate value="${dateValue2}" var="dateEnd"
														pattern="yyyy-MM-dd" />
													<tr>
