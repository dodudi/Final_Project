			...
			<div class="row">
				...
				<div class="col-3 nav-background">
					...
					<div class="list-group">
						...
						<!--member-->
						<a href="/hotel/mypage/member" class="list-group-item list-group-item-action" style="background-color:#f8b600">
				...
				<div class="col content-background">
					...
					<form action="/hotel/mypage/member" method="post">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="MEM_NAME" name="MEM_NAME" value="${member.MEM_NAME }" readonly>
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<small id="MEM_PASS_HELP" class="form-text"></small>
						</div>
						<div class="mb-3">
							<label for="password_check" class="form-label">비밀번호확인</label>
							<input type="password" class="form-control" id="MEM_PASS_CHECK" required>
							<small id="MEM_PASS_CHECK_HELP" class="form-text"></small>
						</div>
						<div class="mb-3">
							<label for="MEM_BIRTH" class="form-label">생일</label>
							<input type="text" class="form-control" id="MEM_BIRTH" name="MEM_BIRTH" value="${member.MEM_BIRTH }" readonly>
						</div>
						<div class="mb-3">
							<label for="MEM_EMAIL" class="form-label">이메일</label>
							<input type="email" class="form-control" id="MEM_EMAIL" name="MEM_EMAIL" value="${member.MEM_EMAIL }" required>
							<small id="MEM_EMIAL_HELP" class="form-text"></small>
						</div>
						<div class="mb-3">
							<label for="MEM_PHONE" class="form-label">전화번호</label>
							<input type="text" class="form-control" id="MEM_PHONE" name="MEM_PHONE" value="${member.MEM_PHONE }" readonly>
						</div>
				...
				.on(
						...
						function() {
							...
							if ($("#MEM_PASS_CHECK").val() != "") {
								if ($("#MEM_PASS").val() != $("#MEM_PASS_CHECK")
										.val()) {
									passCheck = false;
