			...
			<div class="row">
				...
				<div class="col-3 nav-background">
					...
					<div class="list-group">
						...
						<!--question-->
						<a href="/hotel/mypage/question" class="list-group-item list-group-item-action" style="background-color:#f8b600">
				...
				<div class="col-9 content-background">
					...
					<c:if test="${total!=0 }">
						<div class="content-title row justify-content-around">
							<div class="col">문의내역확인</div>
							<div class="tst col-2">
								filter :
							...
							<nav aria-label="Page navigation example">
								<ul id="pagination" class="pagination justify-content-center">
									...
									<c:if test="${pageCalc.prev == true}">
										<fmt:parseNumber var="test" value="${((pageCalc.startPage-1)/pageCalc.pageLimit)  }">
										</fmt:parseNumber>
