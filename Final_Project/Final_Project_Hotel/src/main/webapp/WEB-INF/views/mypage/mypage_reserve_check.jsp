...
<link rel="stylesheet"
	href="/static/vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.css">
<link rel="stylesheet"
			...
			<div class="col-3 nav-background">
				...
				<div class="list-group">
					<a href="#" class="list-group-item list-group-item-action active">
						<img
						src="/static/project_image/mypage_icon/ReservationCheckIcon.png"
						width="25px" alt="" /> 객실예약확인
					</a> <a href="#" class="list-group-item list-group-item-action"> <img
						src="/static/project_image/mypage_icon/QuestionCheck.png"
						width="25px" alt="" /> 문의내역확인
					</a> <a href="#" class="list-group-item list-group-item-action"> <img
						src="/static/project_image/mypage_icon/Coupon.png" width="25px"
						alt="" /> 마일리지 | 쿠폰
					</a> <a href="#" class="list-group-item list-group-item-action"> <img
						src="/static/project_image/mypage_icon/MemberCheck2.png"
						width="25px" alt="" /> 회원정보
					</a> <a href="#" class="list-group-item list-group-item-action"> <img
						src="/static/project_image/mypage_icon/CheckList.png" width="25px"
						alt="" /> 즐겨찾기 게시물 확인
					</a>
				</div>
