        ...
        <div class="container">
            ...
            <div class="row mb_30">
            	<div class="accomodation_item text-center">
                   	<!-- 임시 폼 -->
				    <form action="/hotel/mypage/optionModifyForm" method="post">
				    	객실 번호 : <input type="text" name="ROOM_ID" value="7"><br>
				    	체크인 날짜 : <input type="text" name="REZ_CHECKIN" value="${rezData.REZ_CHECKIN}"><br>
				    	체크아웃 날짜 : <input type="text" name="REZ_CHECKOUT" value="${rezData.REZ_CHECKOUT}"><br>
				    	성인 : <input type="text" name="REZ_ADULT" value="${rezData.REZ_ADULT}"><br>
				    	아동 : <input type="text" name="REZ_CHILD" value="${rezData.REZ_CHILD}"><br>
