...
<section class="sample-text-area">
	<div class="container">
		...
		    <h4><label for="REVIEW_SUBJECT">Title</label></h4>
			<input type="text" class="form-control" name="REVIEW_SUBJECT" id="REVIEW_SUBJECT" placeholder="Enter title" required>     
		...
		     
			...
			<div class="col-sm-12">
				<button style="float:right">취소</button> <!-- 리뷰리스트로 돌아간다 -->
				<button type="submit" id="write" style="float:right">등록</button>
